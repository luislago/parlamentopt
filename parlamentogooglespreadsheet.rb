...
ws[2,7] = (remote_data.css("").text)#Actividade Inicio
ws[2,8] = (remote_data.css("").text)#Actividade Fim
ws[2,9] = (remote_data.css("").text)#Remunerada
ws[2,10] = (remote_data.css("").text)#Cargo
ws[2,11] = (remote_data.css("").text)#Entidade
ws[2,12] = (remote_data.css("").text)#Cargo Inicio
ws[2,13] = (remote_data.css("").text)#Cargo Fim
ws[2,14] = (remote_data.css("").text)#Natureza
ws[2,15] = (remote_data.css("").text)#Sede
ws[2,16] = (remote_data.css("").text)#ApoiosBeneficios
ws[2,17] = (remote_data.css("").text)#Servicos Prestados
ws[2,18] = (remote_data.css("").text)#Entidade Sociedades
ws[2,19] = (remote_data.css("").text)#Area de Actividade
ws[2,20] = (remote_data.css("").text)#Local da sede
ws[2,21] = (remote_data.css("").text)#Participacao Social
ws[2,22] = (remote_data.css("").text)#Outras situacoes	
